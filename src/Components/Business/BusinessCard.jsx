...
export const BusinessCard = () => {
  ...
  let a = businessNews.map((item) => publishedAt === item.publishedAt)
        ...
        publishedAt === item.publishedAt ? (
          <BusinessWrapper key={item}>
            <BusinessLeft>
              <p>
                <Arrow
                  onClick={() => goToLink(businessNews[count - 1].publishedAt)}
                />
                <Arrow
                  onClick={() => goToLink(businessNews[count - 1].publishedAt)}
                />
            ...
            <BusinessMiddle>
              ...
              <Flexs>
                ...
                <BusinessMiddleRight>
                  <h4>TOP STORIES</h4>
                  {businessNews.slice(0, 4).map((item, index) => (
                    <Trending
                      key={index}
                  ...
                  <h4>PAID CONTENT</h4>
                  {businessNews.slice(10, 13).map((item, index) => (
                    <Paid
                      key={index}
                      onClick={() => goToLink(item.publishedAt)}
                    >
